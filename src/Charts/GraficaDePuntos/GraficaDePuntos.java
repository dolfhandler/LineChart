...
import Charts.EventosGraficaDePuntos.EventoMouseMotion;
import Charts.EventosGraficaDePuntos.EventoVentana;
 ...
 * @author DOLFHANDLER
 */
public class GraficaDePuntos extends JPanel {
    ...
    public GraficaDePuntos(Object datos, JPanel contenedor) {
        this.datos = datos;
    ...
    private void pintarListaDePuntos(Graphics2D g) {
        for (int i = 0; i < listaDePuntos.size(); i++) {
            listaDePuntos.get(i).pintar(g);
        }
    }

    private void pintarUnionEntrePuntos(Graphics2D g) {
        ArrayList<ArrayList<Object[]>> data = new ArrayList<>();
        data = (ArrayList<ArrayList<Object[]>>) datos;
